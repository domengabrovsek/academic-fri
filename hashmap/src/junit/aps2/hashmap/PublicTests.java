...
public class PublicTests extends TestCase {
	...
	public void testCustomTestContains() {
		HashMapOpenAddressing hm =
				new HashMapOpenAddressing(
						5,
						HashFunction.HashingMethod.DivisionMethod,
		...
		assertTrue(hm.contains(6));
		assertTrue(hm.contains(10));
		assertTrue(hm.contains(12));
		assertTrue(hm.contains(21));

		assertEquals("F", hm.get(6));
		assertEquals("E", hm.get(10));
		assertEquals("A", hm.get(12));
		assertEquals("B", hm.get(21));
	}
}
